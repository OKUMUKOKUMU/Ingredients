        ...
        if not entries:
            ...
            for identifier, available_quantity in entries:
                ...
                if result is not None:
                    ...
                    formatted_result = result[["DEPARTMENT", "DEPT_PROPORTION", "NORMALIZED_PROPORTION", "ALLOCATED_QUANTITY"]].copy()
                    formatted_result = formatted_result.rename(columns={
                        "DEPARTMENT": "Department",
                        "DEPT_PROPORTION": "Proportion (%)",
                    ...
                    with col3:
                        st.metric("Sub-Departments", f"{formatted_result['Department'].nunique()}")
